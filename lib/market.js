...
exports.getMintDecimals = exports.Orderbook = exports.ORDERBOOK_LAYOUT = exports.OpenOrders = exports.OPEN_ORDERS_LAYOUT = exports.Market = exports.MARKET_STATE_LAYOUT = void 0;
...
class Market {
    ...
    static get LAYOUT() {
        return exports.MARKET_STATE_LAYOUT;
    }
    static async load(connection, address, options = {}, programId) {
        ...
        const decoded = exports.MARKET_STATE_LAYOUT.decode(data);
    ...
    async placeOrder(connection, { owner, payer, side, price, size, orderType = 'limit', clientId, }) {
    ...
    async makePlaceOrderTransaction(connection, { owner, payer, side, price, size, orderType = 'limit', clientId, }, cacheDurationMs = 0) {
        var _a, _b;
        // @ts-ignore
        const ownerAddress = (_a = owner.publicKey) !== null && _a !== void 0 ? _a : owner;
        const openOrdersAccounts = await this.findOpenOrdersAccountsForOwner(connection, ownerAddress, cacheDurationMs); // TODO: cache this
    ...
    async settleFunds(connection, owner, openOrders, baseWallet, quoteWallet) {
...
class OpenOrders {
    ...
    static get LAYOUT() {
        return exports.OPEN_ORDERS_LAYOUT;
    }
    static async findForOwner(connection, ownerAddress, programId) {
        const filters = [
            {
                memcmp: {
                    offset: exports.OPEN_ORDERS_LAYOUT.offsetOf('owner'),
                    bytes: ownerAddress.toBase58(),
                },
            },
            {
                dataSize: exports.OPEN_ORDERS_LAYOUT.span,
            },
        ];
    ...
    static async findForMarketAndOwner(connection, marketAddress, ownerAddress, programId) {
        const filters = [
            {
                memcmp: {
                    offset: exports.OPEN_ORDERS_LAYOUT.offsetOf('market'),
    ...
    static fromAccountInfo(address, accountInfo, programId) {
        ...
        const decoded = exports.OPEN_ORDERS_LAYOUT.decode(data);
    ...
    static async makeCreateAccountTransaction(connection, marketAddress, ownerAddress, newAccountAddress, programId) {
        return web3_js_1.SystemProgram.createAccount({
            ...
            lamports: await connection.getMinimumBalanceForRentExemption(exports.OPEN_ORDERS_LAYOUT.span),
            space: exports.OPEN_ORDERS_LAYOUT.span,
            programId,
        });
    }
    get publicKey() {
